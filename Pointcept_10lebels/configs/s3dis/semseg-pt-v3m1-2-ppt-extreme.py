...
model = dict(
    ...
    # fmt: off
    class_name=(
        "mainBody", "attachment", "cabinet", "bed", "partBody", "partTip", "planetBody", "planetCrater",
        "solarPanel", "bookshelf", "tip", "picture", "counter", "desk", "shelves", "curtain",
        "dresser", "pillow", "mirror", "terrainBody", "refrigerator", "television", "shower curtain", "nightstand",
        "toilet", "sink", "lamp", "bathtub", "garbagebin", "terrainCrater", "beam", "column",
