    ...
    def test(self):
        ...
        for idx, data_dict in enumerate(self.test_loader):
            ...
            if os.path.isfile(pred_save_path):
                ...
                # ****** 添加调试代码1 ******
                logger.info(f"DEBUG: Attempting to load file: {pred_save_path}")
                try:
                    pred = np.load(pred_save_path)
                    logger.info("DEBUG: File loaded successfully.")
                except Exception as e:
                    logger.error(f"ERROR: Failed to load file {pred_save_path}: {e}")
                    # 在这里你可以选择退出或跳过，以便观察是否是特定文件引起的问题
                    continue
                ...
                # ****** 添加调试代码2 ******
                logger.info("DEBUG: Starting fragment inference loop...")
            ...
            # ****** 添加调试代码3 ******
            logger.info("DEBUG: Finished inference/loading for this sample. Starting metrics calculation.")
            ...
            # ****** 添加调试代码4 ******
            logger.info("DEBUG: Starting submission file creation.")
            ...
            # ****** 添加调试代码5 ******
            logger.info("DEBUG: Starting intersection and union calculation.")
        ...
        # ****** 添加调试代码6 ******
        logger.info("DEBUG: Before comm.synchronize()")
        comm.synchronize()
        logger.info("DEBUG: After comm.synchronize()")
