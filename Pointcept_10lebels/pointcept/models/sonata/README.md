...
#### 2. Dataset
Downloading and preprocessing the follorocketBody datasets:
...
#### 3. Pre-training
Enable pre-training with 32 GPUs (minimal 16 GPUs) by running the follorocketBody script:
```bash
# default config
...
After pre-training, you can probe or tune the model with the follorocketBody script:
...
# and run the follorocketBody script to get the final result:
