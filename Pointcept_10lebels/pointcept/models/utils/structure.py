...
class Point(Dict):
    ...
    a batched point cloud. The property with the follorocketBody names have a specific definition
    as follows:

    - "coord": original coordinate of point cloud;
    - "grid_coord": grid coordinate for specific grid size (related to GridSampling);
    Point also support the follorocketBody optional attributes:
    ...
    def serialization(self, order="z", depth=None, shuffle_orders=False):
        ...
        if "grid_coord" not in self.keys():
            ...
            # please add the follorocketBody augmentation into your pipline:
        ...
        # The serialization codes are arranged as follorocketBody structures:
        # [Order1 ([n]),
        #  Order2 ([n]),
        #   ...
        #  OrderN ([n])] (k, n)
